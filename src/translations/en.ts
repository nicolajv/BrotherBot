export const englishDictionary: Dictionary = {
  ...
  customCommandParam2N: 'help',
  customCommandParam2D: 'Help text for the new command',
  customCommandParam3N: 'description',
  customCommandParam3D: 'Description of the new command',
